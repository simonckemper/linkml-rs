...
fn create_test_schema() -> SchemaDefinition {
    ...
    schema.slots.insert("department".to_string(), department_slot);
    ...
    user_class.unique_keys.insert("unique_email".to_string(), email_unique);
    ...
    user_class.unique_keys.insert("unique_username".to_string(), username_unique);
    ...
    employee_class.unique_keys.insert("unique_email_dept".to_string(), composite_unique);
...
async fn test_single_field_uniqueness() {
    ...
    let email_error = errors.iter()
        .find(|e| e.message.contains("unique_email"))
        .expect("Should have email uniqueness error");
    assert!(email_error.message.contains("email"), "Email error should mention the email slot");
    ...
    let username_error = errors.iter()
        .find(|e| e.message.contains("unique_username"))
        .expect("Should have username uniqueness error");
    assert!(username_error.message.contains("username"), "Username error should mention the username slot");
    // Check context contains the duplicate value
