...
async fn test_typeql_generation_with_complex_schema() {
    ...
    schema.slots.insert("founded_date".to_string(), founded_date_slot);
    ...
    organization_class.slots = vec!["name".to_string(), "founded_date".to_string(), "employees".to_string()];
    
    let mut person_class = ClassDefinition::default();
    person_class.name = "Person".to_string();
    person_class.description = Some("A person".to_string());
    person_class.slots = vec!["name".to_string(), "email".to_string(), "employer".to_string()];
    ...
    schema.classes.insert("NamedEntity".to_string(), named_entity_class);
...
async fn test_typeql_generation_with_relations() {
    ...
    schema.slots.insert("start_date".to_string(), start_date_slot);
