...
fn create_advanced_schema() -> SchemaDefinition {
    ...
    schema.slots.insert("enrollment_date".to_string(), date_slot);
...
async fn test_nested_relation_detection() {
    ...
    schema.slots.insert("enrollment".to_string(), enrollment_slot);
...
async fn test_role_inheritance() {
    ...
    schema.classes.insert("Participation".to_string(), participation);
    ...
    schema.slots.insert("participant".to_string(), participant_slot);
...
fn test_role_cardinality() {
    ...
    // Create entities
    schema.classes.insert("Author".to_string(), ClassDefinition::default());
    schema.classes.insert("Book".to_string(), ClassDefinition::default());
