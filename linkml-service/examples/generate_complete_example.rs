...
fn main() -> std::result::Result<(), Box<dyn std::error::Error>> {
    ...
    let schema_path = PathBuf::from("/home/kempersc/apps/rootreal/docs/linkml/generated-examples/simple_schema.yaml");
    ...
    let rust_path = PathBuf::from("/home/kempersc/apps/rootreal/docs/linkml/generated-examples/iso3166_complete.rs");
    ...
    let python_path = PathBuf::from("/home/kempersc/apps/rootreal/docs/linkml/generated-examples/iso3166_dataclass.py");
    fs::write(&python_path, &python_code)?;
    println!("✓ Generated {} lines of Python dataclass code", python_code.lines().count());
    ...
    let pydantic_path = PathBuf::from("/home/kempersc/apps/rootreal/docs/linkml/generated-examples/iso3166_pydantic.py");
    fs::write(&pydantic_path, &pydantic_code)?;
    println!("✓ Generated {} lines of Pydantic model code", pydantic_code.lines().count());
