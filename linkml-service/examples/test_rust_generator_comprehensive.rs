...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    schema.slots.insert("first_name".to_string(), first_name_slot);
    ...
    schema.slots.insert("birth_date".to_string(), birth_date_slot);
    ...
    let rust_gen = registry.get_generator("rust")
