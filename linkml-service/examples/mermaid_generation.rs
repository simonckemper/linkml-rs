...
use linkml_service::generator::{MermaidGenerator, MermaidDiagramType, Generator, GeneratorOptions};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    schema.classes.insert("Identifiable".to_string(), identifiable);
    ...
    book.slots = vec!["title".to_string(), "isbn".to_string(), "authors".to_string(), "publisher".to_string(), "status".to_string()];
    ...
    author.slots = vec!["name".to_string(), "biography".to_string(), "books".to_string()];
    ...
    member.slots = vec!["name".to_string(), "email".to_string(), "membership_type".to_string(), "loans".to_string()];
    ...
    loan.slots = vec!["book".to_string(), "member".to_string(), "loan_date".to_string(), "due_date".to_string(), "return_date".to_string()];
    ...
    schema.slots.insert("membership_type".to_string(), membership_slot);
    ...
    schema.enums.insert("MembershipType".to_string(), membership_type);
    ...
    println!("-----------------");
    let class_generator = MermaidGenerator::new()
    ...
    println!("-------------------------------");
    let state_generator = MermaidGenerator::new()
        .with_diagram_type(MermaidDiagramType::StateDiagram);
    ...
    println!("------------------------------");
    let flow_generator = MermaidGenerator::new()
        .with_diagram_type(MermaidDiagramType::Flowchart);
    let result = flow_generator.generate(&schema, &GeneratorOptions::default()).await?;
