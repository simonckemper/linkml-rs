...
use linkml_service::{
    generator::{ExcelGenerator, ExcelOptions, ExcelFormat},
    schema::{Schema, SchemaBuilder, ClassBuilder, SlotBuilder},
    Result,
};
use std::path::Path;
...
fn create_research_schema() -> Result<Schema> {
    ...
    builder.add_enum("ProjectStatus")
    ...
    builder.add_enum("PublicationType")
    ...
    builder.add_class("ResearchProject")
    ...
    builder.add_class("TeamMember")
        ...
        .add_slot("role")
            .range("string")
            .required(true)
            .enum_values(vec!["PI", "Co-PI", "Postdoc", "PhD Student", "Research Assistant"])
    ...
    builder.add_class("FundingSource")
    ...
    builder.add_example("ResearchProject", serde_json::json!({
    ...
    builder.add_example("TeamMember", serde_json::json!({
        "member_id": "TM-000123",
        "name": "Dr. Jane Smith",
    ...
    builder.add_example("Publication", serde_json::json!({
