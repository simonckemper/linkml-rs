...
use linkml_service::generator::{RdfGenerator, RdfMode, RdfFormat, Generator, GeneratorOptions};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    status_enum.permissible_values.push(
    ...
    println!("-------------------------");
    let jsonld_generator = RdfGenerator::new()
    ...
    println!("---------------------------");
    let ntriples_generator = RdfGenerator::simple()
