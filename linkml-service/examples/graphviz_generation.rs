...
use linkml_service::generator::{GraphvizGenerator, Generator, GeneratorOptions};
use linkml_service::generator::graphviz::{GraphvizStyle, GraphvizLayout, GraphvizOptions};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    customer.slots = vec!["name".to_string(), "email".to_string(), "orders".to_string()];
    ...
    product.slots = vec!["name".to_string(), "price".to_string(), "category".to_string()];
    ...
    order.slots = vec!["customer".to_string(), "order_items".to_string(), "total".to_string(), "status".to_string()];
    ...
    order_item.slots = vec!["product".to_string(), "quantity".to_string(), "price".to_string()];
    ...
    schema.slots.insert("created_at".to_string(), created_at_slot);
    ...
    schema.slots.insert("order_items".to_string(), order_items_slot);
    ...
    schema.enums.insert("ProductCategory".to_string(), product_category);
    ...
    println!("------------------------");
    let simple_generator = GraphvizGenerator::new()
        .with_style(GraphvizStyle::Simple);
    let result = simple_generator.generate(&schema, &GeneratorOptions::default()).await?;
    ...
    println!("---------------------------");
    let uml_generator = GraphvizGenerator::new()
        .with_style(GraphvizStyle::Uml);
    let result = uml_generator.generate(&schema, &GeneratorOptions::default()).await?;
    println!("Generated: {}", result[0].filename);
    ...
    println!("-----------------------------");
    let er_generator = GraphvizGenerator::new()
        .with_style(GraphvizStyle::EntityRelationship);
    ...
    let result = hierarchical_generator.generate(&schema, &GeneratorOptions::default()).await?;
    ...
    let result = lr_generator.generate(&schema, &GeneratorOptions::default()).await?;
