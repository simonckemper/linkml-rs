...
"#;
    ...
    let typeql = service.generate_code(&schema, "typeql", &GeneratorOptions::default()).await?;
    ...
    let graphql = service.generate_code(&schema, "graphql", &GeneratorOptions::default()).await?;
    ...
    let json_schema = service.generate_code(&schema, "jsonschema", &GeneratorOptions::default()).await?;
    ...
    let rust_code = service.generate_code(&schema, "rust", &GeneratorOptions::default()).await?;
    ...
    let python_code = service.generate_code(&schema, "python", &GeneratorOptions::default()).await?;
    ...
    let owl = service.generate_code(&schema, "owl", &GeneratorOptions::default()).await?;
    ...
    for (name, gen_type) in generators {
        ...
        let _ = service.generate_code(&schema, gen_type, &GeneratorOptions::default()).await?;
