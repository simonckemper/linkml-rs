...
impl Generator for GraphQLGenerator {
    ...
    async fn generate(
        ...
        // Header
        writeln!(&mut output, "# GraphQL Schema generated from LinkML").map_err(Self::fmt_error_to_generator_error)?;
...
mod tests {
    ...
    async fn test_graphql_generation() {
        ...
        let outputs = generator.generate(&schema, &options).await.expect("should generate GraphQL output");
