...
"
    ...
    let logger =
        logger_service::wiring::wire_development_logger(timestamp_service.clone().into_arc())?
            .into_arc();
    ...
    let task_service = Arc::new(task_management_service::wiring::wire_task_management()?);
