...
pub fn merge_element_metadata(
    ...
    ElementMetadata {
        ...
        deprecated: override_metadata.deprecated.clone().or_else(|| base.deprecated.clone()),
        replaced_by: override_metadata.replaced_by.clone().or_else(|| base.replaced_by.clone()),
...
mod tests {
    ...
    fn test_element_metadata() {
        ...
        metadata.see_also.push("https://example.org/related".to_string());
    ...
    fn test_merge_metadata() {
        ...
        assert_eq!(merged.deprecated, Some("Use new_element instead".to_string()));
    }
