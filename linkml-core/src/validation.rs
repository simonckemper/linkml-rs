...
impl ValidationResult {
    ...
    pub fn add_message(&mut self, message: ValidationMessage) {
        ...
        if matches!(message.severity, ValidationSeverity::Error | ValidationSeverity::Critical) {
            self.is_valid = false;
        }
    ...
    pub fn add_critical(&mut self, message: impl Into<String>) {
        self.add_message(ValidationMessage::new(ValidationSeverity::Critical, message));
    }
